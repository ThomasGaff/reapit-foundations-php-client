...
/**
 * ListItemModel Class Doc Comment
 *
 * @category Class
 * @description Representation of a configuration item
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListItemModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListItemModel';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the list item
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The textual value for the list item
     *
     * @return self
     */
