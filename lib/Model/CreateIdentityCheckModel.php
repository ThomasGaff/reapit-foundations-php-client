...
/**
 * CreateIdentityCheckModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new contact identity check
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateIdentityCheckModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIdentityCheckModel';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'negotiatorId' => 'string',
        'identityDocument1' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\IdentityChecksIdentityDocument1',
        'identityDocument2' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\IdentityChecksIdentityDocument1',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['checkDate'] === null) {
            $invalidProperties[] = "'checkDate' can't be null";
        }
        ...
        if ($this->container['identityDocument1'] === null) {
            $invalidProperties[] = "'identityDocument1' can't be null";
        }
     ...
     * Sets contactId
     *
     * @param string $contactId The unique identifier of the contact associated to the identity check
     *
     * @return self
     */
     ...
     * Sets checkDate
     *
     * @param \DateTime $checkDate The date when the identity check was performed. This may differ to the date when the check was created
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The current status of the identity check (pass/fail/pending/cancelled/warnings/unchecked)
     *
     * @return self
     */
     ...
     * Sets negotiatorId
     *
     * @param string $negotiatorId The unique identifier of the negotiator that initiated the identity check
     *
     * @return self
     */
     ...
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\IdentityChecksIdentityDocument1
     */
     ...
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\IdentityChecksIdentityDocument1 $identityDocument1 identityDocument1
     *
     * @return self
     */
     ...
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\IdentityChecksIdentityDocument1|null
     */
     ...
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\IdentityChecksIdentityDocument1|null $identityDocument2 identityDocument2
     *
     * @return self
     */
