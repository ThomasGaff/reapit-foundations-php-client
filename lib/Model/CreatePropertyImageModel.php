...
/**
 * CreatePropertyImageModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new property image
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreatePropertyImageModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePropertyImageModel';
     ...
     * Sets data
     *
     * @param string|null $data The base64 encoded file content, prefixed with the content type (eg. data:image/jpeg;base64,VGVzdCBmaWxl)
     *
     * @return self
     */
     ...
     * Sets fileUrl
     *
     * @param string|null $fileUrl The presigned s3 url which a property image has been uploaded to (This supports files up to 30MB)
     *
     * @return self
     */
     ...
     * Sets propertyId
     *
     * @param string $propertyId The unique identifier of the property attached to the image
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of image (picture/floorPlan/epc/map)
     *
     * @return self
     */
