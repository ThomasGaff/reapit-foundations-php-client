...
/**
 * UpdateTenancySourceModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to set the source of a new tenancy
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateTenancySourceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTenancySourceModel';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the source for the tenancy
     *
     * @return self
     */
