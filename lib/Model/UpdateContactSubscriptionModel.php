...
/**
 * UpdateContactSubscriptionModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to update an existing contact subscription
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateContactSubscriptionModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateContactSubscriptionModel';
