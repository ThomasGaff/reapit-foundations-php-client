...
/**
 * LandlordContactRelationshipModel Class Doc Comment
 *
 * @category Class
 * @description Representation of relationship between a landlord and a contact or company
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LandlordContactRelationshipModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LandlordContactRelationshipModel';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the landlord relationship
     *
     * @return self
     */
     ...
     * Sets landlordId
     *
     * @param string|null $landlordId The unique identifier of the landlord
     *
     * @return self
     */
     ...
     * Sets isMain
     *
     * @param bool|null $isMain A flag denoting whether or not the relationship should be regarded as the main relationship for the parent landlord entity
     *
     * @return self
     */
