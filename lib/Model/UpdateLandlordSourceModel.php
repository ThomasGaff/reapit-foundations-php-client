...
/**
 * UpdateLandlordSourceModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to update the source of an existing landlord
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateLandlordSourceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateLandlordSourceModel';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the source of the landlord
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The source type (office/source)
     *
     * @return self
     */
