...
/**
 * UpdateCompanyModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to update an existing company
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateCompanyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateCompanyModel';
    ...
    protected static $openAPITypes = [
        ...
        'mobilePhone' => 'string',
        'email' => 'string',
        'address' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\CompaniesIdAddress',
     ...
     * Gets address
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\CompaniesIdAddress|null
     */
     ...
     * Sets address
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\CompaniesIdAddress|null $address address
     *
     * @return self
     */
