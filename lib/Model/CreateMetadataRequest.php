...
/**
 * CreateMetadataRequest Class Doc Comment
 *
 * @category Class
 * @description Payload to create a metadata record
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateMetadataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets entityId
     *
     * @param string|null $entityId The unique identifier of the entity that this metadata is related to.  For custom entities, this can be left blank and an id will be generated for you.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,object> $metadata The JSON document to store
     *
     * @return self
     */
