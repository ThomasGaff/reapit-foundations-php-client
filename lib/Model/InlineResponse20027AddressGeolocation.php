...
/**
 * InlineResponse20027AddressGeolocation Class Doc Comment
 *
 * @category Class
 * @description Representation of the geographical location of an address using coordinates
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineResponse20027AddressGeolocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_27_address_geolocation';
     ...
     * Sets latitude
     *
     * @param double|null $latitude The latitude coordinate of the coordinate pair
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param double|null $longitude The longitude coordinate of the coordinate pair
     *
     * @return self
     */
