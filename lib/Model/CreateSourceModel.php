...
/**
 * CreateSourceModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new source of business
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateSourceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSourceModel';
     ...
     * Sets name
     *
     * @param string $name The name of the source or advertising publication
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the source (source/advertisement)
     *
     * @return self
     */
