...
/**
 * CreateOfficeModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new office
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateOfficeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOfficeModel';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'manager' => 'string',
        'address' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\OfficesAddress',
        'workPhone' => 'string',
        'email' => 'string',
     ...
     * Gets address
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\OfficesAddress
     */
     ...
     * Sets address
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\OfficesAddress $address address
     *
     * @return self
     */
