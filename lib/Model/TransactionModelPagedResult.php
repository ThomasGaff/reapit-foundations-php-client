...
/**
 * TransactionModelPagedResult Class Doc Comment
 *
 * @category Class
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 ...
 */
class TransactionModelPagedResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionModelPagedResult';
    ...
    protected static $openAPITypes = [
        'embedded' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20036Embedded[]',
        'pageNumber' => 'int',
        'pageSize' => 'int',
        'pageCount' => 'int',
        'totalPageCount' => 'int',
     ...
     * Gets embedded
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20036Embedded[]|null
     */
     ...
     * Sets embedded
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20036Embedded[]|null $embedded embedded
     *
     * @return self
     */
