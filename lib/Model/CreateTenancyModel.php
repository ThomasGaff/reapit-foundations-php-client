...
/**
 * CreateTenancyModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new tenancy
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateTenancyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTenancyModel';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['agentRole'] === null) {
            $invalidProperties[] = "'agentRole' can't be null";
        }
        if ($this->container['rent'] === null) {
            $invalidProperties[] = "'rent' can't be null";
        }
        if ($this->container['rentFrequency'] === null) {
            $invalidProperties[] = "'rentFrequency' can't be null";
        }
     ...
     * Sets status
     *
     * @param string|null $status The current status of the tenancy (offerPending/offerWithdrawn/offerRejected/arranging)
     *
     * @return self
     */
     ...
     * Sets agentRole
     *
     * @param string $agentRole The role that the agent is performing for the tenancy (managed/rentCollection/collectFirstPayment/collectRentToDate/lettingOnly/introducingTenant)
     *
     * @return self
     */
     ...
     * Sets rent
     *
     * @param int $rent The amount of rent required, returned in relation to the collection frequency
     *
     * @return self
     */
     ...
     * Sets rentFrequency
     *
     * @param string $rentFrequency The rent collection frequency (weekly/monthly/annually)
     *
     * @return self
     */
     ...
     * Sets typeId
     *
     * @param string $typeId The unique identifier of the type of tenancy
     *
     * @return self
     */
     ...
     * Sets negotiatorId
     *
     * @param string $negotiatorId The unique identifier of the negotiator who is managing the tenancy
     *
     * @return self
     */
     ...
     * Sets propertyId
     *
     * @param string $propertyId The unique identifier of the property that relates to the tenancy
     *
     * @return self
     */
     ...
     * Sets applicantId
     *
     * @param string $applicantId The unique identifier of the applicant who has applied to be a tenant
     *
     * @return self
     */
