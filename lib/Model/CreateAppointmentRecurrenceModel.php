...
/**
 * CreateAppointmentRecurrenceModel Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateAppointmentRecurrenceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAppointmentRecurrenceModel';
     ...
     * Sets until
     *
     * @param \DateTime|null $until The date and time when the recurrence will stop. (Required if 'type' is provided)
     *
     * @return self
     */
