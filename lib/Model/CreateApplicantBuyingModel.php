...
/**
 * CreateApplicantBuyingModel Class Doc Comment
 *
 * @category Class
 * @description The details specific to applicants with a marketingMode of buying
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateApplicantBuyingModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateApplicantBuyingModel';
    ...
    {
        $this->container['priceFrom'] = $data['priceFrom'] ?? null;
        $this->container['priceTo'] = $data['priceTo'] ?? null;
    }
     ...
     * Sets priceFrom
     *
     * @param int|null $priceFrom The lower bound of the applicant's budget. (Required when 'marketingMode' is 'buying' and 'priceTo' is not provided)
     *
     * @return self
     */
     ...
     * Sets priceTo
     *
     * @param int|null $priceTo The upper bound of the applicant's budget. (Required when 'marketingMode' is 'buying' and 'priceFrom' is not provided)
     *
     * @return self
     */
