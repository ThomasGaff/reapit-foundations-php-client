...
/**
 * UpdatePropertyCommissionFeeModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to update the commission fee for a property
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdatePropertyCommissionFeeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePropertyCommissionFeeModel';
     ...
     * Sets type
     *
     * @param string|null $type The commission letting fee type (percentage/fixed)
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param double|null $amount The commission letting fee amount
     *
     * @return self
     */
