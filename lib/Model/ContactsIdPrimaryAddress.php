...
/**
 * ContactsIdPrimaryAddress Class Doc Comment
 *
 * @category Class
 * @description Request body used to update an address on an existing contact
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactsIdPrimaryAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_contacts__id__primaryAddress';
     ...
     * Sets countryId
     *
     * @param string|null $countryId The ISO-3166 country code that the adderess resides in
     *
     * @return self
     */
