...
/**
 * CreateCertificateModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new certificate
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateCertificateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCertificateModel';
     ...
     * Sets companyId
     *
     * @param string|null $companyId The unique identifier of the company that supplied, or is supplying, the certificate
     *
     * @return self
     */
