...
/**
 * ApplicantContactRelationshipModel Class Doc Comment
 *
 * @category Class
 * @description Representation of a relationship between an applicant and a contact or company
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplicantContactRelationshipModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicantContactRelationshipModel';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the applicant relationship
     *
     * @return self
     */
     ...
     * Sets applicantId
     *
     * @param string|null $applicantId The unique identifier of the applicant
     *
     * @return self
     */
     ...
     * Sets isMain
     *
     * @param bool|null $isMain A flag denoting whether or not this relationship should be regarded as the main relationship for the parent applicant entity
     *
     * @return self
     */
