...
/**
 * UpdateOfficeModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to update an existing office
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateOfficeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateOfficeModel';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'manager' => 'string',
        'address' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\OfficesIdAddress',
        'workPhone' => 'string',
        'email' => 'string',
     ...
     * Gets address
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\OfficesIdAddress|null
     */
     ...
     * Sets address
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\OfficesIdAddress|null $address address
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,object>|null $metadata App specific metadata to set against the office
     *
     * @return self
     */
