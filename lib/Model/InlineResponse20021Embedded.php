...
/**
 * InlineResponse20021Embedded Class Doc Comment
 *
 * @category Class
 * @description Model representing the state of a metadata record for a given entity
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineResponse20021Embedded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_21__embedded';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of this metadata record
     *
     * @return self
     */
     ...
     * Sets modified
     *
     * @param \DateTime|null $modified The date and time of when this metadata record was last updated
     *
     * @return self
     */
     ...
     * Sets entityType
     *
     * @param string|null $entityType The name of the entity type that this metadata record is associated to
     *
     * @return self
     */
     ...
     * Sets entityId
     *
     * @param string|null $entityId The unique identifier of the the entity that this metadata is associated to
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,object>|null $metadata The JSON document content
     *
     * @return self
     */
