...
/**
 * CreateApplicantRentingModel Class Doc Comment
 *
 * @category Class
 * @description The details specific to applicants with a marketingMode of renting
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateApplicantRentingModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateApplicantRentingModel';
    ...
    {
        $this->container['moveDate'] = $data['moveDate'] ?? null;
        $this->container['term'] = $data['term'] ?? null;
        $this->container['rentFrom'] = $data['rentFrom'] ?? null;
        $this->container['rentTo'] = $data['rentTo'] ?? null;
    ...
    {
        return $this->container['moveDate'];
    }

    /**
     * Sets moveDate
     *
     * @param \DateTime|null $moveDate The date the applicant is looking to move to a new property
     *
     * @return self
     */
    public function setMoveDate($moveDate)
    {
        $this->container['moveDate'] = $moveDate;
     ...
     * Sets term
     *
     * @param string|null $term The applicant's preferred letting term (long/short/any)
     *
     * @return self
     */
    ...
    {
        return $this->container['rentFrom'];
    }

    /**
     * Sets rentFrom
     *
     * @param double|null $rentFrom The lower bound of the applicant's budget. (Required when 'marketingMode' is 'renting' and 'rentTo' is 0)
     *
     * @return self
     */
    public function setRentFrom($rentFrom)
    {
        $this->container['rentFrom'] = $rentFrom;
    ...
    {
        return $this->container['rentTo'];
    }

    /**
     * Sets rentTo
     *
     * @param double|null $rentTo The upper bound of the applicant's budget. (Required when 'marketingMode' is 'renting' and 'rentFrom' is 0)
     *
     * @return self
     */
    public function setRentTo($rentTo)
    {
        $this->container['rentTo'] = $rentTo;
     ...
     * Sets rentFrequency
     *
     * @param string|null $rentFrequency The desired rent collection frequency specified by the applicant's budget (weekly/monthly/annually).
     *
     * @return self
     */
     ...
     * Sets furnishing
     *
     * @param string[]|null $furnishing A list of property furnishing requirements taken from the full listing of the associated department
     *
     * @return self
     */
