...
/**
 * InlineResponse20037Source Class Doc Comment
 *
 * @category Class
 * @description Representation of a vendor&#39;s source
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineResponse20037Source implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_37_source';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the source of the vendor
     *
     * @return self
     */
