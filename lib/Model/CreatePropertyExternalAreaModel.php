...
/**
 * CreatePropertyExternalAreaModel Class Doc Comment
 *
 * @category Class
 * @description Request body to set the external land area of a new property
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreatePropertyExternalAreaModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePropertyExternalAreaModel';
