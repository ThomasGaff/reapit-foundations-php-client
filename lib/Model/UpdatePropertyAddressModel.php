...
/**
 * UpdatePropertyAddressModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to update the address of an existing property
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdatePropertyAddressModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePropertyAddressModel';
    ...
    protected static $openAPITypes = [
        ...
        'postcode' => 'string',
        'countryId' => 'string',
        'geolocation' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\PropertiesIdAddressGeolocation'
    ];
     ...
     * Gets geolocation
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\PropertiesIdAddressGeolocation|null
     */
     ...
     * Sets geolocation
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\PropertiesIdAddressGeolocation|null $geolocation geolocation
     *
     * @return self
     */
