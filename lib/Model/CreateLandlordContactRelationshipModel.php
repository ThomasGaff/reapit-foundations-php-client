...
/**
 * CreateLandlordContactRelationshipModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new relationship between a landlord and a contact or company
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateLandlordContactRelationshipModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateLandlordContactRelationshipModel';
