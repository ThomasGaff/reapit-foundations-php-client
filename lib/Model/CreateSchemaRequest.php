...
/**
 * CreateSchemaRequest Class Doc Comment
 *
 * @category Class
 * @description Payload to create a JSON schema for metadata validation
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateSchemaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSchemaRequest';
     ...
     * Sets entityType
     *
     * @param string $entityType The name of the entity type that this schema is related to
     *
     * @return self
     */
     ...
     * Sets schema
     *
     * @param string $schema The JSON schema used to validate entities of this type
     *
     * @return self
     */
