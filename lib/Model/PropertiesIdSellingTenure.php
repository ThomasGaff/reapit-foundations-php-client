...
/**
 * PropertiesIdSellingTenure Class Doc Comment
 *
 * @category Class
 * @description Request body used to set the tenure of an existing property
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PropertiesIdSellingTenure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_properties__id__selling_tenure';
