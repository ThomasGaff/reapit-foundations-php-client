...
/**
 * CreateLandlordSourceModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to set the source of a new landlord
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateLandlordSourceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateLandlordSourceModel';
