...
/**
 * CreateApplicantInternalAreaModel Class Doc Comment
 *
 * @category Class
 * @description The applicant&#39;s indoor space requirements
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateApplicantInternalAreaModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateApplicantInternalAreaModel';
     ...
     * Sets type
     *
     * @param string|null $type The unit of area that each amount corresponds to (squareFeet/squareMetres)
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param double|null $amount The unit value of inside space that the applicant is looking for
     *
     * @return self
     */
