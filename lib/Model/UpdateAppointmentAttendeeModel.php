<?php
/**
 * UpdateAppointmentAttendeeModel
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * UpdateAppointmentAttendeeModel Class Doc Comment
 *
 * @category Class
 * @description Represents an external attendee on an appointment
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateAppointmentAttendeeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateAppointmentAttendeeModel';
     ...
     * Sets type
     *
     * @param string|null $type The type of attendee (applicant/contact/landlord/tenant)
     *
     * @return self
     */
     ...
     * Sets confirmed
     *
     * @param bool|null $confirmed A flag denoting whether or not the attendee has confirmed their attendance
     *
     * @return self
     */
