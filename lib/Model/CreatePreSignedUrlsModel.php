...
/**
 * CreatePreSignedUrlsModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create pre signed urls to upload files between 6MB and 30MB
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreatePreSignedUrlsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePreSignedUrlsModel';
     ...
     * Sets amount
     *
     * @param int $amount The number of pre signed urls to create
     *
     * @return self
     */
