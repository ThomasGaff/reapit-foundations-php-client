...
/**
 * UpdateContactSourceModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to update the source of an existing contact
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateContactSourceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateContactSourceModel';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the source of the contact
     *
     * @return self
     */
