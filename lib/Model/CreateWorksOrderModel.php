...
/**
 * CreateWorksOrderModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new works order
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateWorksOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateWorksOrderModel';
    ...
    protected static $openAPITypes = [
        ...
        'required' => '\DateTime',
        'completed' => '\DateTime',
        'items' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineObject57[]',
     ...
     * Sets propertyId
     *
     * @param string $propertyId The unique identifier of the property where the work is to be carried out
     *
     * @return self
     */
     ...
     * Sets negotiatorId
     *
     * @param string $negotiatorId The unique identifier of the negotiator that booked the works order
     *
     * @return self
     */
     ...
     * Sets typeId
     *
     * @param string $typeId The unique id of the type of work that needs to be carried out
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The current status of the works order (pendingApproval/pendingQuote/raised/raisedToChase/landlordToComplete/complete/cancelled)
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description A free text description of the work required
     *
     * @return self
     */
     ...
     * Sets reporter
     *
     * @param string $reporter The party requesting the work to be carried out (landlord/tenant/other)
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineObject57[]
     */
     ...
     * Sets items
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineObject57[] $items Individual work items to attach to the works order
     *
     * @return self
     */
