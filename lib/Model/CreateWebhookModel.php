...
/**
 * CreateWebhookModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new webhook subscription
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateWebhookModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateWebhookModel';
     ...
     * Sets url
     *
     * @param string $url The url where the payload associated with the webhook should be sent to
     *
     * @return self
     */
     ...
     * Sets topicIds
     *
     * @param string[]|null $topicIds The identifiers of the topics the subscription is associated with
     *
     * @return self
     */
     ...
     *
     * @param bool|null $ignoreEtagOnlyChanges Flag denoting whether or events that only contain changes to etags and/or modified dates are emitted  Pass true to disable emitting of these events
     *
     * @return self
     */
