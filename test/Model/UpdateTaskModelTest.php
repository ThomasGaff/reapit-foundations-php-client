...
/**
 * UpdateTaskModelTest Class Doc Comment
 *
 * @category    Class
 * @description Request body used to update an existing task, which can also be an internal message
 * @package     OpenAPI\Client
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class UpdateTaskModelTest extends TestCase
{
     ...
     */
    public function testUpdateTaskModel()
    {
        // TODO: implement
