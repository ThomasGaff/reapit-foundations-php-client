...
/**
 * CreatePropertyRoomModel Class Doc Comment
 *
 * @category Class
 * @description Request body to create a room in the Rooms collection of a new property
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreatePropertyRoomModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePropertyRoomModel';
     ...
     * Sets name
     *
     * @param string|null $name The name of the room
     *
     * @return self
     */
     ...
     * Sets dimensions
     *
     * @param string|null $dimensions Details about the dimensions of the room
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Short description of the room
     *
     * @return self
     */
