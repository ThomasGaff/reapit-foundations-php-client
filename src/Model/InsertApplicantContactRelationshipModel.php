...
/**
 * InsertApplicantContactRelationshipModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create or update a relationship between an applicant and a contact or company
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InsertApplicantContactRelationshipModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertApplicantContactRelationshipModel';
     ...
     * Sets associatedId
     *
     * @param string|null $associatedId The unique identifier of the contact or company to create a relationship with
     *
     * @return self
     */
     ...
     * Sets associatedType
     *
     * @param string|null $associatedType The type of relationship to create (contact/company)
     *
     * @return self
     */
     ...
     * Sets isMain
     *
     * @param bool|null $isMain Flag denoting whether or not this relationship should be considered to be the main/primary relationship. Setting to true will automatically demote the existing primary relationship
     *
     * @return self
     */
