...
/**
 * CreateEnquiryAddressModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a enquiries address
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateEnquiryAddressModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateEnquiryAddressModel';
     ...
     * Sets buildingName
     *
     * @param string|null $buildingName Sets the building name
     *
     * @return self
     */
     ...
     * Sets buildingNumber
     *
     * @param string|null $buildingNumber Sets the building number
     *
     * @return self
     */
     ...
     * Sets line1
     *
     * @param string|null $line1 Sets the first line of the address
     *
     * @return self
     */
     ...
     * Sets line2
     *
     * @param string|null $line2 Sets the second line of the address
     *
     * @return self
     */
     ...
     * Sets line3
     *
     * @param string|null $line3 Sets the third line of the address
     *
     * @return self
     */
     ...
     * Sets line4
     *
     * @param string|null $line4 Sets the fourth line of the address
     *
     * @return self
     */
     ...
     * Sets postcode
     *
     * @param string|null $postcode Sets the postcode
     *
     * @return self
     */
     ...
     * Sets countryId
     *
     * @param string|null $countryId Sets the ISO-3166 country code that the address resides within
     *
     * @return self
     */
