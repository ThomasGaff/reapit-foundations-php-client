...
/**
 * SchemaModel Class Doc Comment
 *
 * @category Class
 * @description Model representing a JSON schema used to validate a specific entity type
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SchemaModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SchemaModel';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of this JSON schema
     *
     * @return self
     */
     ...
     * Sets modified
     *
     * @param \DateTime|null $modified The date and time of when this JSON schema was last updated
     *
     * @return self
     */
     ...
     * Sets schema
     *
     * @param string|null $schema The JSON schema document
     *
     * @return self
     */
