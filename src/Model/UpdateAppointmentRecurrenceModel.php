<?php
/**
 * UpdateAppointmentRecurrenceModel
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * UpdateAppointmentRecurrenceModel Class Doc Comment
 *
 * @category Class
 * @description Details of an appointment&#39;s recurrence pattern
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateAppointmentRecurrenceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateAppointmentRecurrenceModel';
     ...
     * Sets type
     *
     * @param string|null $type The type of unit that the `interval` applies to (daily/weekly/yearly/monthly)
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param int|null $interval The numeric value denoting how often the appointment will recur
     *
     * @return self
     */
     ...
     * Sets until
     *
     * @param \DateTime|null $until The date and time when the recurrence will stop
     *
     * @return self
     */
