<?php
/**
 * UpdatePropertyInternalAreaModel
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * UpdatePropertyInternalAreaModel Class Doc Comment
 *
 * @category Class
 * @description Request body to update the internal dimensions of an existing property
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdatePropertyInternalAreaModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePropertyInternalAreaModel';
