<?php
/**
 * UpdateApplicantExternalAreaModel
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * UpdateApplicantExternalAreaModel Class Doc Comment
 *
 * @category Class
 * @description The applicant&#39;s outdoor space requirements
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateApplicantExternalAreaModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateApplicantExternalAreaModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['amountFrom'] = $data['amountFrom'] ?? null;
        $this->container['amountTo'] = $data['amountTo'] ?? null;
    }
     ...
     * Sets type
     *
     * @param string|null $type The unit of area that each amount corresponds to (acres/hectares)
     *
     * @return self
     */
    ...
    {
        return $this->container['amountFrom'];
    }

    /**
     * Sets amountFrom
     *
     * @param double|null $amountFrom The minimum unit value of outside space that the applicant is looking for
     *
     * @return self
     */
    public function setAmountFrom($amountFrom)
    {
        $this->container['amountFrom'] = $amountFrom;
    ...
    {
        return $this->container['amountTo'];
    }

    /**
     * Sets amountTo
     *
     * @param double|null $amountTo The maximum unit value of outside space that the applicant is looking for
     *
     * @return self
     */
    public function setAmountTo($amountTo)
    {
        $this->container['amountTo'] = $amountTo;
