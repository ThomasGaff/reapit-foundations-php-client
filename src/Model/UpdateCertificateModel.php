...
/**
 * UpdateCertificateModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to update an existing certificate
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateCertificateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateCertificateModel';
