...
/**
 * IdentityChecksIdIdentityDocument1 Class Doc Comment
 *
 * @category Class
 * @description Request body to update an identity document attached to an existing contact identity check
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class IdentityChecksIdIdentityDocument1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_identityChecks__id__identityDocument1';
     ...
     * Sets typeId
     *
     * @param string|null $typeId The unique identifier of the type of identity document provided
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param string|null $details Details regarding the identity document (eg. passport number)
     *
     * @return self
     */
     ...
     * Sets fileData
     *
     * @param string|null $fileData The base64 encoded identity document content, prefixed with the content type (eg. data:text/plain;base64,VGVzdCBmaWxl)  The total request payload cannot exceed 6Mb, regardless of the number of documents being sent
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The filename to store the document as
     *
     * @return self
     */
