...
/**
 * CreatePropertyAddressModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to set the address of a new property
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreatePropertyAddressModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePropertyAddressModel';
    ...
    protected static $openAPITypes = [
        ...
        'postcode' => 'string',
        'countryId' => 'string',
        'geolocation' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\PropertiesAddressGeolocation'
    ];
     ...
     * Gets geolocation
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\PropertiesAddressGeolocation|null
     */
     ...
     * Sets geolocation
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\PropertiesAddressGeolocation|null $geolocation geolocation
     *
     * @return self
     */
