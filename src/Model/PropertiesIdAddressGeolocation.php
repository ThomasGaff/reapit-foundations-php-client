...
/**
 * PropertiesIdAddressGeolocation Class Doc Comment
 *
 * @category Class
 * @description Request body used to update the geolocation coordinates of an existing property&#39;s address
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PropertiesIdAddressGeolocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_properties__id__address_geolocation';
