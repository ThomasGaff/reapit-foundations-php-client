...
/**
 * CreateContactSourceModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to set the source of a new contact
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateContactSourceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateContactSourceModel';
