 ...
 *
 * @category Class
 * @description Representation of a vendor
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VendorModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VendorModel';
    ...
    protected static $openAPITypes = [
        ...
        'related' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20037Related[]',
        'negotiatorId' => 'string',
        'officeIds' => 'string[]',
        'archivedOn' => '\DateTime',
        'fromArchive' => 'bool',
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the vendor
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date and time when the vendor was created
     *
     * @return self
     */
     ...
     * Sets modified
     *
     * @param \DateTime|null $modified The date and time when the vendor was last modified
     *
     * @return self
     */
     ...
     * Sets solicitorId
     *
     * @param string|null $solicitorId The unique identifier of the solicitor associated to the vendor
     *
     * @return self
     */
     ...
     * Sets propertyId
     *
     * @param string|null $propertyId The unique identifier of the property associated to the vendor
     *
     * @return self
     */
     ...
     * Gets related
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20037Related[]|null
     */
     ...
     * Sets related
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20037Related[]|null $related A collection of contacts and/or companies associated to the vendor. The first item in the collection is considered the primary relationship
     *
     * @return self
     */
     ...
     * Sets negotiatorId
     *
     * @param string|null $negotiatorId The unique identifier of the negotiator attached to the vendor. The first item in the collection is considered the primary negotiator
     *
     * @return self
     */
     ...
     * Sets officeIds
     *
     * @param string[]|null $officeIds A collection of unique identifiers of offices attached to the vendor. The first item in the collection is considered the primary office
     *
     * @return self
     */
     ...
     * Sets archivedOn
     *
     * @param \DateTime|null $archivedOn The date and time the vendor was archived
     *
     * @return self
     */
     ...
     * Sets fromArchive
     *
     * @param bool|null $fromArchive A flag determining whether or not the vendor is archived
     *
     * @return self
     */
     ...
     * Sets eTag
     *
     * @param string|null $eTag The ETag for the current version of the vendor. Used for managing update concurrency
     *
     * @return self
     */
