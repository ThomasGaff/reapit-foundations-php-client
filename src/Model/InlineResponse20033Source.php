...
/**
 * InlineResponse20033Source Class Doc Comment
 *
 * @category Class
 * @description A tenancy source of enquiry
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineResponse20033Source implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_33_source';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the source for this tenancy
     *
     * @return self
     */
