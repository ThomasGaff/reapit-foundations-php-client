...
/**
 * UpdateSchemaRequest Class Doc Comment
 *
 * @category Class
 * @description Payload to update a JSON schema
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateSchemaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSchemaRequest';
     ...
     * Sets schema
     *
     * @param string $schema The updated JSON schema to store
     *
     * @return self
     */
