...
/**
 * CreateTenancyCheckModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new tenancy check
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateTenancyCheckModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTenancyCheckModel';
     ...
     * Sets description
     *
     * @param string $description Short, descriptive text describing the purpose of the check
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the tenancy check (preTenancy/postTenancy)
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The status of the tenancy check (needed/notNeeded/arranging/completed)
     *
     * @return self
     */
