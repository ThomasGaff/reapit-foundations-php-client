<?php
/**
 * UpdateAppointmentFollowUpModel
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * UpdateAppointmentFollowUpModel Class Doc Comment
 *
 * @category Class
 * @description Represents the follow up information on a single appointment
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateAppointmentFollowUpModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateAppointmentFollowUpModel';
     ...
     * Sets notes
     *
     * @param string|null $notes The internal follow up notes to be stored against the appointment
     *
     * @return self
     */
