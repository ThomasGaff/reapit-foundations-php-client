...
/**
 * WorksOrderItemModelPagedResult Class Doc Comment
 *
 * @category Class
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 ...
 */
class WorksOrderItemModelPagedResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorksOrderItemModelPagedResult';
    ...
    protected static $openAPITypes = [
        'embedded' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20040Items[]',
        'pageNumber' => 'int',
        'pageSize' => 'int',
        'pageCount' => 'int',
        'totalPageCount' => 'int',
     ...
     * Sets embedded
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20040Items[]|null $embedded embedded
     *
     * @return self
     */
