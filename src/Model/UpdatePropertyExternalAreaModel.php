...
/**
 * UpdatePropertyExternalAreaModel Class Doc Comment
 *
 * @category Class
 * @description Request body to update the external land area of an existing property
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdatePropertyExternalAreaModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePropertyExternalAreaModel';
     ...
     * Sets type
     *
     * @param string|null $type The unit of area (acres/hectares)
     *
     * @return self
     */
