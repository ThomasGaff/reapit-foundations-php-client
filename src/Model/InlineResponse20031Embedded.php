...
/**
 * InlineResponse20031Embedded Class Doc Comment
 *
 * @category Class
 * @description Representation of a source of business
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineResponse20031Embedded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_31__embedded';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the source
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date and time when the source was created
     *
     * @return self
     */
     ...
     * Sets modified
     *
     * @param \DateTime|null $modified The date and time when the source was last modified
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the source or advertising publication
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of the source (source/advertisement)
     *
     * @return self
     */
     ...
     * Sets officeIds
     *
     * @param string[]|null $officeIds A collection of the unique identifiers of offices that regularly get business from the source
     *
     * @return self
     */
     ...
     * Sets departmentIds
     *
     * @param string[]|null $departmentIds A collection of unique identifiers of departments that regularly get business from the source
     *
     * @return self
     */
     ...
     * Sets eTag
     *
     * @param string|null $eTag The ETag for the current version of the source. Used for managing update concurrency
     *
     * @return self
     */
