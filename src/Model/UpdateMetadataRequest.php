...
/**
 * UpdateMetadataRequest Class Doc Comment
 *
 * @category Class
 * @description Payload to update a metadata record
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateMetadataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateMetadataRequest';
     ...
     * Sets metadata
     *
     * @param array<string,object> $metadata The updated JSON document to store
     *
     * @return self
     */
