...
/**
 * CreateUpwardLinkModel Class Doc Comment
 *
 * @category Class
 * @description Request body for associating this offer to another one above it in the chain
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateUpwardLinkModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateUpwardLinkModel';
     ...
     * Sets offerId
     *
     * @param string|null $offerId The unique identifier of the offer above this one in the chain. Should be left empty if the upward property is external (instructed by another agent)
     *
     * @return self
     */
     ...
     *
     * @param string|null $propertyAddress The address of the property above this one in the chain. (Required when 'offerId' is not provided)
     *
     * @return self
     */
     ...
     * Sets vendor
     *
     * @param string|null $vendor The name of the vendor selling the property. (Required when 'offerId' is not provided)
     *
     * @return self
     */
     ...
     *
     * @param string|null $vendorSolicitorId The unique identifier of the solicitor / conveyancer that the vendor has instructed. (Required when 'offerId' is not provided)
     *
     * @return self
     */
