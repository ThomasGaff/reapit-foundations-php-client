...
/**
 * UpdateApplicantBuyingModel Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateApplicantBuyingModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateApplicantBuyingModel';
     ...
     * Sets priceFrom
     *
     * @param int|null $priceFrom The lower bound of the applicant's budget
     *
     * @return self
     */
     ...
     * Sets priceTo
     *
     * @param int|null $priceTo The upper bound of the applicant's budget
     *
     * @return self
     */
