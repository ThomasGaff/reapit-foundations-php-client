...
/**
 * CreateAreaModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new area
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateAreaModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAreaModel';
     ...
     * Sets type
     *
     * @param string $type The type of area (postcodes/polygon/group)
     *
     * @return self
     */
     ...
     * Sets area
     *
     * @param string[] $area The location details (comma delimited list of postcodes, group ids or lat/long coordinate groups)
     *
     * @return self
     */
     ...
     * Sets parentId
     *
     * @param string|null $parentId The unique identifier of the parent area, if the area should be registered as a child area/group in an existing area group
     *
     * @return self
     */
