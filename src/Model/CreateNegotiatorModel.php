...
/**
 * CreateNegotiatorModel Class Doc Comment
 *
 * @category Class
 * @description Request body used to create a new negotiator
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateNegotiatorModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateNegotiatorModel';
     ...
     * Sets name
     *
     * @param string $name The name of the negotiator
     *
     * @return self
     */
     ...
     * Sets officeId
     *
     * @param string $officeId The unique identifier of the office that the negotiator is attached to
     *
     * @return self
     */
