...
/**
 * InlineResponse20027SellingTenure Class Doc Comment
 *
 * @category Class
 * @description Representation of the tenure of a property
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineResponse20027SellingTenure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_27_selling_tenure';
     ...
     * Sets type
     *
     * @param string|null $type The type of tenure that applies to the property (freehold/leasehold/shareOfFreehold/commonhold/tba)
     *
     * @return self
     */
     ...
     * Sets expiry
     *
     * @param \DateTime|null $expiry The tenure expiration date
     *
     * @return self
     */
