...
/**
 * InlineResponse2003Attendee Class Doc Comment
 *
 * @category Class
 * @description An appointment attendee
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineResponse2003Attendee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_3_attendee';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'type' => 'string',
        'contacts' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse2003AttendeeContacts[]'
    ];
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the attendee
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of attendee
     *
     * @return self
     */
     ...
     * Gets contacts
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse2003AttendeeContacts[]|null
     */
     ...
     * Sets contacts
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse2003AttendeeContacts[]|null $contacts A collection of contacts relating to the attendee
     *
     * @return self
     */
