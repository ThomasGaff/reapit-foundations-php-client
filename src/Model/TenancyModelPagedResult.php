...
/**
 * TenancyModelPagedResult Class Doc Comment
 *
 * @category Class
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 ...
 */
class TenancyModelPagedResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TenancyModelPagedResult';
    ...
    protected static $openAPITypes = [
        'embedded' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20033Embedded[]',
        'pageNumber' => 'int',
        'pageSize' => 'int',
        'pageCount' => 'int',
        'totalPageCount' => 'int',
     ...
     * Gets embedded
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20033Embedded[]|null
     */
     ...
     * Sets embedded
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20033Embedded[]|null $embedded embedded
     *
     * @return self
     */
