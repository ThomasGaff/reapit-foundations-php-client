...
/**
 * TenancyContactRelationshipModel Class Doc Comment
 *
 * @category Class
 * @description Representation of a relationship between a tenancy and a contact or company
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TenancyContactRelationshipModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TenancyContactRelationshipModel';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the tenancy relationship
     *
     * @return self
     */
     ...
     * Sets tenancyId
     *
     * @param string|null $tenancyId The unique identifier of the tenancy
     *
     * @return self
     */
     ...
     * Sets isMain
     *
     * @param bool|null $isMain A flag denoting whether or not this contact or company should be regarded as the main tenant
     *
     * @return self
     */
