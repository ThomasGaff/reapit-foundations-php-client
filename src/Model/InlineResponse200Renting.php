...
/**
 * InlineResponse200Renting Class Doc Comment
 *
 * @category Class
 ...
 */
class InlineResponse200Renting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_renting';
     ...
     * Sets rentFrom
     *
     * @param double|null $rentFrom The lower bound of the applicant's budget
     *
     * @return self
     */
     ...
     * Sets rentTo
     *
     * @param double|null $rentTo The upper bound of the applicant's budget
     *
     * @return self
     */
     ...
     * Sets furnishing
     *
     * @param string[]|null $furnishing A list of property furnishing requirements taken from the full listing of the associated department. Only applicable to applicants with a marketingMode of renting
     *
     * @return self
     */
