...
/**
 * InlineResponse20025Embedded Class Doc Comment
 *
 * @category Class
 * @description Representation of an offer
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineResponse20025Embedded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_25__embedded';
    ...
    protected static $openAPITypes = [
        ...
        'exclusions' => 'string',
        'conditions' => 'string',
        'related' => '\NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20025Related[]',
     ...
     * Sets created
     *
     * @param \DateTime|null $created The the date and time when the offer was created
     *
     * @return self
     */
     ...
     * Sets modified
     *
     * @param \DateTime|null $modified The date and time when the offer was last modified
     *
     * @return self
     */
     ...
     * Sets applicantId
     *
     * @param string|null $applicantId The unique identifier of the applicant associated to the offer
     *
     * @return self
     */
     ...
     * Sets propertyId
     *
     * @param string|null $propertyId The unique identifier of the property associated to the offer
     *
     * @return self
     */
     ...
     * Gets related
     *
     * @return \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20025Related[]|null
     */
     ...
     * Sets related
     *
     * @param \NorthernEstateAgencies\ReapitFoundationsClient\Model\InlineResponse20025Related[]|null $related A collection of contacts associated to the offer
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,object>|null $metadata App specific metadata that has been set against the offer
     *
     * @return self
     */
     ...
     * Sets eTag
     *
     * @param string|null $eTag The ETag for the current version of the offer. Used for managing update concurrency
     *
     * @return self
     */
