...
/**
 * StaffModel Class Doc Comment
 *
 * @category Class
 * @description Representation of a staff member
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class StaffModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StaffModel';
     ...
     * Sets name
     *
     * @param string|null $name The staff member's name
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active A flag determining whether or not the staff member is currently active
     *
     * @return self
     */
     ...
     * Sets jobTitle
     *
     * @param string|null $jobTitle The staff member's job title
     *
     * @return self
     */
     ...
     * Sets workPhone
     *
     * @param string|null $workPhone The staff member's work phone
     *
     * @return self
     */
     ...
     * Sets mobilePhone
     *
     * @param string|null $mobilePhone The staff member's mobile phone
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email The staff member's email
     *
     * @return self
     */
