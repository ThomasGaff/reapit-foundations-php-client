...
/**
 * PropertiesAddressGeolocation Class Doc Comment
 *
 * @category Class
 * @description Request body used to set the geolocation coordinates of a new property&#39;s address
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PropertiesAddressGeolocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_properties__address_geolocation';
     ...
     * Sets latitude
     *
     * @param double $latitude The latitude coordinate of the coordinate pair
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param double $longitude The longitude coordinate of the coordinate pair
     *
     * @return self
     */
