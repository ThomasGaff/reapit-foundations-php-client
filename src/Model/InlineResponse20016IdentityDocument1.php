<?php
/**
 * InlineResponse20016IdentityDocument1
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * InlineResponse20016IdentityDocument1 Class Doc Comment
 *
 * @category Class
 * @description Representation of a single identity document that was provided as part of a contact identity check (eg. passport)
 * @package  NorthernEstateAgencies\ReapitFoundationsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineResponse20016IdentityDocument1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_16_identityDocument1';
     ...
     * Sets documentId
     *
     * @param string|null $documentId The unique identifier of the identity document
     *
     * @return self
     */
